...
<link href="my/my.sass" rel="stylesheet" type="text/css">
...
<div class="offcanvas d-inline mybg-light d-sm-none offcanvas-start container nbo w-50" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
...
<div class="col-sm-2 center m-2 col-4 border">
<a href="Helper/product.php?pid=<?= $product["id"] ?>" class="nav-link">
<img src="imgs/<?= $product["proimg"][0] ?>" class=" productsimg" > 
...
<form action="Helper/sendmail.php" method="POST">
<input type="text" name="inemail" placeholder="E-Mail" class="form-control mt-2">
<input type="text" name="inmass" placeholder="Massage" class="form-control mt-2" >
<button class="btn btn-primary  mt-2"><i class="fas fa-paper-plane"></i>Send</button>
</form>
